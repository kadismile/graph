...
class GrossSales extends React.Component {
  ...
  componentDidMount() {
    ...
    let thirtyDaysOrders = this.thisData(30, this.props.grossSales);
  ...
  onDatefilter = (day) => {
    ...
    if (day === 'today') {
      let grossSales = this.props.grossSales;
      ...
      setTimeout(() => {
        this.setState({
          text: 'than yesterday',
          totalOrders: this.formatTotal(totalGrossSalesT),
      ...
      setTimeout(() => {
        this.setState({
          text: 'than today',
          totalOrders: this.formatTotal(totalgrossSalesYesterday),
          percentGrowth:percentGrowth
        });
      }, 1200);
    }
      ...
      setTimeout(() => {
        this.setState({
          text: 'than last week',
          totalOrders: this.formatTotal(totalGrossSalesThisweek),
          percentGrowth: percentGrowth,
        });
      }, 1200);
    }
      ...
      this.setState({
        text: 'than this week',
        totalOrders: this.formatTotal(totalGrossSalesLastweek),
        percentGrowth: percentGrowth
      });
    }
      ...
      this.setState({
        ...
        totalOrders: this.formatTotal(totalGrossSalesThisMonth),
        percentGrowth: percentGrowth
      });
    }
  };
    ...
    return (
      <div className="col-sm-6 col-lg-3">
        <div className="card card-body">
          ...
          <h6 className="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Gross Sales
          ...
          <div className="chart-three">
            <div id="flotChart11" className="flot-chart ht-30" style={{padding: '0px', position: 'relative'}}>
...
function mapStateToProps(state) {
  return {
    auth: state.auth,
    grossSales: state.graphData.grossSales,
  }
}
...
function matchDispatchToProps(dispatch) {
  return {
    onGetGraphData() {
      dispatch(graphActions.queryGrossSales())
    }
...
export default connect(mapStateToProps, matchDispatchToProps)(GrossSales);
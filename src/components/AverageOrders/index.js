...
class AverageOrders extends React.Component {
  ...
  componentDidMount() {
    ...
    let thirtyDaysOrders = this.thisData(30, this.props.averageOrders);
  ...
  onDatefilter = (day) => {
    ...
    if (day === 'today') {
      let averageSales = this.props.averageOrders;
    ...
    return (
      <div className="col-sm-6 col-lg-3">
        <div className="card card-body">
          ...
          <h6 className="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Average Orders
...
function mapStateToProps(state) {
  return {
    averageOrders: state.graphData.averageOrders,
  }
}
...
function matchDispatchToProps(dispatch) {
  return {
    onGetGraphData() {
      dispatch(graphActions.queryAverageOrders())
    }
...
export default connect(mapStateToProps, matchDispatchToProps)(AverageOrders);
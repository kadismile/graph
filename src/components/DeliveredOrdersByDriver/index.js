...
class DeliveredOrdersByDriver extends React.Component {
  ...
  onDatefilter = (day) => {
    ...
    if (day === 'today') {
      let DeliveredOrdersByDriver = this.props.DeliveredOrdersByDriver;
      let data = _.filter(DeliveredOrdersByDriver, function (m) {
        ...
        <div className="col-md-6 col-xl-4 mg-t-10">
          <div className="card ht-100p">
            <div className="card-header d-flex align-items-center justify-content-between">
              <h6 className="mg-b-0">Delivered Orders By Driver </h6>
...
function mapStateToProps(state) {
  return {
    auth: state.auth,
    DeliveredOrdersByDriver: state.graphData.DeliveredOrdersByDriver,
  }
}
...
function matchDispatchToProps(dispatch) {
  return {
    onGetGraphData() {
      dispatch(graphActions.querydeliveredOrdersByDriver())
    }
...
export default connect(mapStateToProps, matchDispatchToProps)(DeliveredOrdersByDriver);